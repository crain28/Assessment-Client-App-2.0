    ...
    class Program
    {
        ...
        static void DisplayAddMonster(List<Monster> monsters)
        {
            ...
            do
            {
                ...
                Console.Write("\tYou are Active either[true or false]: ");
        ...
        static void DisplayUpdateMonster(List<Monster> monsters)
        {
            ...
            Console.Write($"\tCurrently Active: {selectedMonster.Active} Are you Active[true or false]: ");
            userResponse = Console.ReadLine();
            if (userResponse != "")
            {
